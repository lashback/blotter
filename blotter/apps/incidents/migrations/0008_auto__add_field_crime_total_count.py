...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crime.total_count'
        db.add_column(u'incidents_crime', 'total_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Crime.total_count'
        db.delete_column(u'incidents_crime', 'total_count')
