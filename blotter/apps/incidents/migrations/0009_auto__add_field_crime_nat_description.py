...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crime.nat_description'
        db.add_column(u'incidents_crime', 'nat_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Crime.nat_description'
        db.delete_column(u'incidents_crime', 'nat_description')
    ...
    models = {
        ...
        u'incidents.crime': {
            ...
            'nat_description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
