...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crime.name'
        db.alter_column(u'incidents_crime', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Crime.name'
        db.alter_column(u'incidents_crime', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
