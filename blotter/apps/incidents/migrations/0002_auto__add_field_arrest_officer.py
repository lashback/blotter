...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Arrest.officer'
        db.add_column(u'incidents_arrest', 'officer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents.Officer'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Arrest.officer'
        db.delete_column(u'incidents_arrest', 'officer_id')
